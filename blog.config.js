...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1769d1402e3380a08115ee88039eddba,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '杨连地', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一位勤劳的作者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://yld.netlify.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, YLD, 杨连地', // 网站关键词 英文逗号隔开
