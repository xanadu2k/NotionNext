...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1749d1402e3380eaab04e4a5bddc1451,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  APPEARANCE_DARK_TIME: process.env.NEXT_PUBLIC_APPEARANCE_DARK_TIME || false, // 夜间模式起至时间，false时关闭根据时间自动切换夜间模式 格式[18, 6]

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'YLD', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一位勤劳的作者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://yld.netlify.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, YLD', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    '无论时光如何流转，只要心中有梦，脚步就不停追寻。让我们永远保持年轻的心态，活出精彩的人生！', //Hi，我是一个程序员, Hi，我是一个打工人,Hi，我是一个干饭人,欢迎来到我的博客
